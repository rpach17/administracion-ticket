...
<Assembly: EdmRelationshipAttribute("ModeloTablas", "ARCHIVOS_FK1", "CAMPOS_FORM", System.Data.Metadata.Edm.RelationshipMultiplicity.One, GetType(CAMPOS_FORM), "ARCHIVOS", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(ARCHIVOS), True)>
...
<Assembly: EdmRelationshipAttribute("ModeloTablas", "MARCADORES_FK2", "ARCHIVOS", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, GetType(ARCHIVOS), "MARCADORES", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, GetType(MARCADORES), True)>
...
Public Partial Class EntidadesTablas
    ...
    ''' <summary>
    ''' Inicializa un nuevo objeto EntidadesTablas usando la cadena de conexión encontrada en la sección 'EntidadesTablas' del archivo de configuración de la aplicación.
    ''' </summary>
    Public Sub New()
    ...
    ''' <summary>
    ''' Inicializar un nuevo objeto EntidadesTablas.
    ''' </summary>
    ...
    ''' No hay documentación de metadatos disponible.
    ''' </summary>
    Public ReadOnly Property DIAS_FERIADOS() As ObjectSet(Of DIAS_FERIADOS)
        Get
            If (_DIAS_FERIADOS Is Nothing) Then
                _DIAS_FERIADOS = MyBase.CreateObjectSet(Of DIAS_FERIADOS)("DIAS_FERIADOS")
            End If
            Return _DIAS_FERIADOS
        End Get
    End Property
    ...
    ''' No hay documentación de metadatos disponible.
    ''' </summary>
    Public ReadOnly Property VALIDACIONES() As ObjectSet(Of VALIDACIONES)
        Get
            If (_VALIDACIONES Is Nothing) Then
                _VALIDACIONES = MyBase.CreateObjectSet(Of VALIDACIONES)("VALIDACIONES")
            End If
    ...
    ''' <summary>
    ''' Método desusado para agregar un nuevo objeto al EntitySet DIAS_FERIADOS. Considere la posibilidad de usar el método .Add de la propiedad ObjectSet(Of T) asociada.
    ''' </summary>
    ...
    ''' <summary>
    ''' Método desusado para agregar un nuevo objeto al EntitySet EMPRESAS. Considere la posibilidad de usar el método .Add de la propiedad ObjectSet(Of T) asociada.
    ''' </summary>
    ...
    ''' <summary>
    ''' Método desusado para agregar un nuevo objeto al EntitySet VALIDACIONES. Considere la posibilidad de usar el método .Add de la propiedad ObjectSet(Of T) asociada.
    ''' </summary>
...
Public Partial Class ARCHIVOS
    ...
    Public Shared Function CreateARCHIVOS(iDARCHIVO As Global.System.Decimal, iDCAMPO_FORM As Global.System.Decimal) As ARCHIVOS
        Dim aRCHIVOS as ARCHIVOS = New ARCHIVOS
        aRCHIVOS.IDARCHIVO = iDARCHIVO
        aRCHIVOS.IDCAMPO_FORM = iDCAMPO_FORM
        Return aRCHIVOS
    End Function
    ...
    <SoapIgnoreAttribute()>
    <DataMemberAttribute()>
    <EdmRelationshipNavigationPropertyAttribute("ModeloTablas", "MARCADORES_FK2", "MARCADORES")>
     Public Property MARCADORES() As EntityCollection(Of MARCADORES)
        Get
            Return CType(Me,IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of MARCADORES)("ModeloTablas.MARCADORES_FK2", "MARCADORES")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of MARCADORES)("ModeloTablas.MARCADORES_FK2", "MARCADORES", value)
            End If
        End Set
    End Property
...
Public Partial Class CAMPOS_FORM
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=false, IsNullable:=true)>
    <DataMemberAttribute()>
    Public Property SQL_QUERY() As Global.System.String
        Get
            Return _SQL_QUERY
        End Get
        Set
            OnSQL_QUERYChanging(value)
            ReportPropertyChanging("SQL_QUERY")
            _SQL_QUERY = StructuralObject.SetValidValue(value, true)
            ReportPropertyChanged("SQL_QUERY")
            OnSQL_QUERYChanged()
        End Set
    End Property

    Private _SQL_QUERY As Global.System.String
    Private Partial Sub OnSQL_QUERYChanging(value As Global.System.String)
    End Sub

    Private Partial Sub OnSQL_QUERYChanged()
    End Sub
    ...
    <SoapIgnoreAttribute()>
    <DataMemberAttribute()>
    <EdmRelationshipNavigationPropertyAttribute("ModeloTablas", "CAMPOS_FORM_FK3", "VALIDACIONES")>
    Public Property VALIDACIONES() As VALIDACIONES
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of VALIDACIONES)("ModeloTablas.CAMPOS_FORM_FK3", "VALIDACIONES").Value
        End Get
        Set
            CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of VALIDACIONES)("ModeloTablas.CAMPOS_FORM_FK3", "VALIDACIONES").Value = value
        End Set
    End Property
    ''' <summary>
    ''' No hay documentación de metadatos disponible.
    ...
    <BrowsableAttribute(False)>
    <DataMemberAttribute()>
    Public Property VALIDACIONESReference() As EntityReference(Of VALIDACIONES)
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of VALIDACIONES)("ModeloTablas.CAMPOS_FORM_FK3", "VALIDACIONES")
        End Get
        Set
            If (Not value Is Nothing)
...
''' No hay documentación de metadatos disponible.
''' </summary>
<EdmEntityTypeAttribute(NamespaceName:="ModeloTablas", Name:="DIAS_FERIADOS")>
<Serializable()>
<DataContractAttribute(IsReference:=True)>
Public Partial Class DIAS_FERIADOS
    ...
    ''' <summary>
    ''' Crear un nuevo objeto DIAS_FERIADOS.
    ''' </summary>
    ''' <param name="fECHA">Valor inicial de la propiedad FECHA.</param>
    Public Shared Function CreateDIAS_FERIADOS(fECHA As Global.System.DateTime) As DIAS_FERIADOS
        Dim dIAS_FERIADOS as DIAS_FERIADOS = New DIAS_FERIADOS
        dIAS_FERIADOS.FECHA = fECHA
...
''' No hay documentación de metadatos disponible.
''' </summary>
<EdmEntityTypeAttribute(NamespaceName:="ModeloTablas", Name:="IDENTIFICACION")>
<Serializable()>
<DataContractAttribute(IsReference:=True)>
...
''' No hay documentación de metadatos disponible.
''' </summary>
<EdmEntityTypeAttribute(NamespaceName:="ModeloTablas", Name:="MARCADORES")>
<Serializable()>
<DataContractAttribute(IsReference:=True)>
Public Partial Class MARCADORES
    ...
    ''' <summary>
    ''' Crear un nuevo objeto MARCADORES.
    ''' </summary>
    ''' <param name="iDMARCADOR">Valor inicial de la propiedad IDMARCADOR.</param>
    Public Shared Function CreateMARCADORES(iDMARCADOR As Global.System.Decimal) As MARCADORES
        Dim mARCADORES as MARCADORES = New MARCADORES
        mARCADORES.IDMARCADOR = iDMARCADOR
        Return mARCADORES
    End Function
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=true, IsNullable:=false)>
    <DataMemberAttribute()>
    Public Property IDMARCADOR() As Global.System.Decimal
        Get
            Return _IDMARCADOR
        End Get
        Set
            If (_IDMARCADOR <> Value) Then
                OnIDMARCADORChanging(value)
                ReportPropertyChanging("IDMARCADOR")
                _IDMARCADOR = StructuralObject.SetValidValue(value)
                ReportPropertyChanged("IDMARCADOR")
                OnIDMARCADORChanged()
            End If
        End Set
    End Property

    Private _IDMARCADOR As Global.System.Decimal
    Private Partial Sub OnIDMARCADORChanging(value As Global.System.Decimal)
    End Sub

    Private Partial Sub OnIDMARCADORChanged()
    End Sub
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=false, IsNullable:=true)>
    <DataMemberAttribute()>
    Public Property IDARCHIVO() As Nullable(Of Global.System.Decimal)
        Get
            Return _IDARCHIVO
        End Get
        Set
    ...
    Private _IDARCHIVO As Nullable(Of Global.System.Decimal)
    Private Partial Sub OnIDARCHIVOChanging(value As Nullable(Of Global.System.Decimal))
    End Sub
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=false, IsNullable:=true)>
    <DataMemberAttribute()>
    Public Property MARCADOR() As Global.System.String
        Get
            Return _MARCADOR
        End Get
        Set
            OnMARCADORChanging(value)
            ReportPropertyChanging("MARCADOR")
            _MARCADOR = StructuralObject.SetValidValue(value, true)
            ReportPropertyChanged("MARCADOR")
            OnMARCADORChanged()
        End Set
    End Property

    Private _MARCADOR As Global.System.String
    Private Partial Sub OnMARCADORChanging(value As Global.System.String)
    End Sub
    ...
    <SoapIgnoreAttribute()>
    <DataMemberAttribute()>
    <EdmRelationshipNavigationPropertyAttribute("ModeloTablas", "MARCADORES_FK2", "ARCHIVOS")>
    Public Property ARCHIVOS() As ARCHIVOS
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of ARCHIVOS)("ModeloTablas.MARCADORES_FK2", "ARCHIVOS").Value
        End Get
        Set
            CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of ARCHIVOS)("ModeloTablas.MARCADORES_FK2", "ARCHIVOS").Value = value
        End Set
    End Property
    ''' <summary>
    ''' No hay documentación de metadatos disponible.
    ...
    Public Property ARCHIVOSReference() As EntityReference(Of ARCHIVOS)
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of ARCHIVOS)("ModeloTablas.MARCADORES_FK2", "ARCHIVOS")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of ARCHIVOS)("ModeloTablas.MARCADORES_FK2", "ARCHIVOS", value)
            End If
        End Set
    End Property
...
Public Partial Class PUESTO
    ...
    <SoapIgnoreAttribute()>
    <DataMemberAttribute()>
    <EdmRelationshipNavigationPropertyAttribute("ModeloTablas", "USUARIOS_FK2", "USUARIOS")>
     Public Property USUARIOS() As EntityCollection(Of USUARIOS)
        Get
            Return CType(Me,IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of USUARIOS)("ModeloTablas.USUARIOS_FK2", "USUARIOS")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of USUARIOS)("ModeloTablas.USUARIOS_FK2", "USUARIOS", value)
            End If
        End Set
    End Property
...
Public Partial Class USUARIOS
    ...
    Public Property PUESTO() As PUESTO
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of PUESTO)("ModeloTablas.USUARIOS_FK2", "PUESTO").Value
        End Get
        Set
            CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of PUESTO)("ModeloTablas.USUARIOS_FK2", "PUESTO").Value = value
        End Set
    End Property
    ''' <summary>
    ''' No hay documentación de metadatos disponible.
    ...
    Public Property PUESTOReference() As EntityReference(Of PUESTO)
        Get
            Return CType(Me, IEntityWithRelationships).RelationshipManager.GetRelatedReference(Of PUESTO)("ModeloTablas.USUARIOS_FK2", "PUESTO")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedReference(Of PUESTO)("ModeloTablas.USUARIOS_FK2", "PUESTO", value)
            End If
        End Set
    End Property
...
''' No hay documentación de metadatos disponible.
''' </summary>
<EdmEntityTypeAttribute(NamespaceName:="ModeloTablas", Name:="VALIDACIONES")>
<Serializable()>
<DataContractAttribute(IsReference:=True)>
Public Partial Class VALIDACIONES
    ...
    ''' </summary>
    ''' <param name="iDVALIDACION">Valor inicial de la propiedad IDVALIDACION.</param>
    Public Shared Function CreateVALIDACIONES(iDVALIDACION As Global.System.Decimal) As VALIDACIONES
        Dim vALIDACIONES as VALIDACIONES = New VALIDACIONES
        vALIDACIONES.IDVALIDACION = iDVALIDACION
        Return vALIDACIONES
    End Function
    ...
    <EdmScalarPropertyAttribute(EntityKeyProperty:=true, IsNullable:=false)>
    <DataMemberAttribute()>
    Public Property IDVALIDACION() As Global.System.Decimal
        Get
            Return _IDVALIDACION
        End Get
        Set
            If (_IDVALIDACION <> Value) Then
                OnIDVALIDACIONChanging(value)
                ReportPropertyChanging("IDVALIDACION")
                _IDVALIDACION = StructuralObject.SetValidValue(value)
                ReportPropertyChanged("IDVALIDACION")
    ...
    Private _IDVALIDACION As Global.System.Decimal
    Private Partial Sub OnIDVALIDACIONChanging(value As Global.System.Decimal)
    End Sub
    ...
    <SoapIgnoreAttribute()>
    <DataMemberAttribute()>
    <EdmRelationshipNavigationPropertyAttribute("ModeloTablas", "CAMPOS_FORM_FK3", "CAMPOS_FORM")>
     Public Property CAMPOS_FORM() As EntityCollection(Of CAMPOS_FORM)
        Get
            Return CType(Me,IEntityWithRelationships).RelationshipManager.GetRelatedCollection(Of CAMPOS_FORM)("ModeloTablas.CAMPOS_FORM_FK3", "CAMPOS_FORM")
        End Get
        Set
            If (Not value Is Nothing)
                CType(Me, IEntityWithRelationships).RelationshipManager.InitializeRelatedCollection(Of CAMPOS_FORM)("ModeloTablas.CAMPOS_FORM_FK3", "CAMPOS_FORM", value)
            End If
        End Set
    End Property
