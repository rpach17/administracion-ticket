...
Public Class frmTramitesEntregados

    Private Sub frmTramitesEntregados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        ...
        Dim reporte As New rptTramitesEntregados(cboDepto.Text, cboMunic.Text, cboSucursal.Text, cboOficina.Text, cboOficina.SelectedValue, pickerDesde.Text, pickerHasta.Text)
